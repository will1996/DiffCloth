...
static std::vector<std::string> CONSTRAINT_TYPE_STRINGS = std::vector<std::string>{"CONSTRAINT_SPRING",
                                                                                   "CONSTRAINT_ATTACHMENT",
                                                                                   "CONSTRAINT_TRIANGLE",
                                                                                   "CONSTRAINT_TRIANGLE_BENDING"};
static std::vector<std::string> SPLINE_TYPE_STRINGS = std::vector<std::string>{"ENDPOINT", "ENDPOINT_AND_UP",
                                                                               "ENDPOINT_AND_TANGENTS"};


enum Orientation {
    FRONT, DOWN, BACK, CUSTOM_ORIENTATION,
};
enum AttachmentConfigs {
    NO_ATTACHMENTS,
...
static std::vector<std::string> windConfigStrings = std::vector<std::string>{"NO_WIND", "WIND_CONSTANT", "WIND_SIN",
                                                                             "WIND_SIN_AND_FALLOFF",
                                                                             "WIND_FACTOR_PER_STEP"};
enum Demos {
    DEMO_WIND, //0
...
enum CameraFocusPointType {
    ORIGIN, CLOTH_CENTER, PRIM0CENTER, POINT
};
