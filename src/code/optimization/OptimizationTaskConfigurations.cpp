...
Simulation::FabricConfiguration  OptimizationTaskConfigurations::slopeFabricRestOnPlane = {
        .clothDimX = 4.5,
        .clothDimY = 4.5,
...
Simulation::FabricConfiguration  OptimizationTaskConfigurations::dressv7khandsUpDrape = {
        .clothDimX = 13,
        .clothDimY = 13,
...
Simulation::FabricConfiguration  OptimizationTaskConfigurations::ImageLossFabric = {
        .clothDimX = 13,
        .clothDimY = 13,
        .k_stiff_stretching = 3000, //2000,
        .k_stiff_bending =  10, //0.2,
        .gridNumX = 40, // 25,
        .gridNumY = 80, //50,
        .density = 0.3,
        .keepOriginalScalePoint = false,
        ...
        .fabricIdx = FabricEnumArray::DRESS_v7k_DRAPE,
        .color = Vec3d(0.9, 0.9, 0.9),
        .name =  "remeshed/image_loss_init.obj",
};
...
Simulation::SceneConfiguration OptimizationTaskConfigurations::windScene = {
        ...
        .camFocusPointType = CameraFocusPointType::POINT,
        .sceneBbox =  AABB(Vec3d(-7, -7, -7), Vec3d(7, 7, 7)),
        .timeStep = 1.0 / 90.0,
        .stepNum = 200,
        .forwardConvergenceThresh = 1e-9,
...
Simulation::SceneConfiguration OptimizationTaskConfigurations::ImageLossScene = {
        .fabric = ImageLossFabric, 
        .orientation = Orientation::CUSTOM_ORIENTATION,
        .upVector = Vec3d(0.0, 1.0, 0.0).normalized(),
        .attachmentPoints = AttachmentConfigs::CUSTOM_ARRAY,
        .customAttachmentVertexIdx = {{0.0, {0}}}, 
        .trajectory =  TrajectoryConfigs::NO_TRAJECTORY,
        .primitiveConfig = PrimitiveConfiguration::NONE,
        .windConfig = WindConfig::NO_WIND,
        .camPos = Vec3d(0, 5, 20),
...
Simulation::TaskConfiguration OptimizationTaskConfigurations::ImageLoss = {
        .scene = ImageLossScene,
        .hasGroundtruth = false,
        .generateGroundtruthSimulation = false,
        .lossType = LossType::ASSISTED_DRESSING_KEYPOINTS,
};
...
std::map<int, Simulation::TaskConfiguration> OptimizationTaskConfigurations::demoNumToConfigMap = {
        ...
        {IMAGE_LOSS_PROPAGATION,   OptimizationTaskConfigurations::ImageLoss},
};

std::vector<Simulation::SceneConfiguration>  OptimizationTaskConfigurations::sceneConfigArrays = {windScene,
                                                                                                  continousNormalScene, rotatingSphereScene, hatScene, sockScene, tshirtScene, dressScene
,ImageLossScene};
