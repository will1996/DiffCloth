...
public:
    static Simulation::FabricConfiguration    normalFabric6lowres,   slopeFabricRestOnPlane,
      conitnuousNormalTestFabric, tshirt1000,   agenthat579, sock482,  dressv7khandsUpDrape, sphereFabric,
            normalFabric6,ImageLossFabric;


    static Simulation::SceneConfiguration ImageLossScene, simpleScene,   rotatingSphereScene, windScene,
       tshirtScene,
            hatScene,  sockScene, dressScene,
         continousNormalScene, slopeSimplifiedScene;

    static Simulation::TaskConfiguration demoSphere, demoTshirt, demoWInd, demoHat, demoSock, demoDress, demoWindSim2Real, demoSlope, ImageLoss;
